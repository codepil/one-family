...
const SAMPLE_POSTS: Post[] = [
  ...
  },
  {
    ...
    tags: ["events"],
    content:
      "Drafting the checklist for games, food assignments, and carpool details for the picnic at Maple Park.",
  },
  {
    id: "p3",
    ...
    tags: ["recipe"],
    content:
      "A family classic with a mild kick. Ingredients, steps, and secret tips inside.",
  },
];
        ...
        <aside className="md:sticky md:top-20 h-max rounded-xl border bg-card p-5 shadow-sm">
          {mode === "create" ? (
            ...
            <div>
              ...
              <PostForm
                initial={draftFromPost(selected)}
                onCancel={cancel}
                onSave={saveEdit}
              />
            </div>
            ...
            <div>
              ...
              <div className="mt-1 text-xs text-muted-foreground">
                By {selected.author} • {fmtDate(selected.date)} •{" "}
